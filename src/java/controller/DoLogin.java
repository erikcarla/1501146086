...
public class DoLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs = con.execute("SELECT * FROM MsUser WHERE Username = '" + username + "' AND Password = '" + password + "' ");
        try {
            if (rs.next()) {
                //kondisi benar
                ...
                if (app.getAttribute("online") == null) {
                    ...
                    int totalskrg = Integer.parseInt(app.getAttribute("online").toString());
                    totalskrg++;
                    app.setAttribute("online", totalskrg);
                }
